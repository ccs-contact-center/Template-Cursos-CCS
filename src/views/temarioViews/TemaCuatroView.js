          ...
          <Row>
            <Col xs="12 centrado-fila">
              <Col xs="12" sm="12" md="6" className="text-justify">
                <ul>
                  ...
                  <li>
                    Una vez creadas las guías de monitoreo de una campaña nueva,
                    implementación realizará pruebas de estrés para validar la
                    caída de los reportes de calidad.{" "}
                  </li>
            ...
            <Col xs="12 " className="text-justify centrado-fila mt-4">
              <ul>
                ...
                <li>
                  Los monitoreos en histórico se deben realizar el mismo día, si
                  existiera alguna situación como descanso del analista y/o
                  agente, falta, incapacidad, vacaciones, incidencia en sistema,
                  se podrán utilizar grabaciones de 24 a 48 horas.
                </li>
                <li>Tabla de aleatoriedad </li>
                <li>
                  La llamada se elige de manera aleatoria, el criterio puede ser
                  el tiempo de duración.
                </li>
                <li>
                  La llamada con un periodo mayor a 48hrs, se realizará el
                  monitoreo a través de una solicitud interna o de cliente ya
                  sea porque se detectó un error en la llamada o en el proceso.
                </li>
                <li>
            ...
            <Col xs="12" className="text-justify">
              <ul>
                <li>
                  ...
                  Monitoreo el agente se clasificará en la en la escala A, B, C,
                  D que será el número de monitoreó a trabajar.{" "}
                </li>
              </ul>
              <div className="centrado-fila">
                <TablaMonitoreo />
              ...
              <ul>
                <li>
                  Los agentes <b>de nuevo ingreso entran en la escala “D”</b> y
                  se le realizan 5 monitoreos semanales{" "}
                  <b>durante el primer mes</b>, posteriormente se realizan el
                  criterio de monitoreó aplicara de acuerdo con la tabla
                  anterior.{" "}
                </li>
                <li>
                  Se genera audioteca en FTP: Se agregan en carpetas por campaña
                  y por skill.
                </li>
                <li>
                ...
                <li>
                  En la audioteca se cargarán las llamadas que sean consideradas
                  modelo para Coaching, Foda y Error fatal.
                </li>
                <li>(et)</li>
              </ul>
            </Col>
