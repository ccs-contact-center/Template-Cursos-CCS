                  ...
                  <Row>
                    <Col xs="12" className="mb-4">
                      <div className="paddingCarousel text-justify">
                        <ul className="pl-2">
                          <li>
                            <b>In Bound</b>: Transacciones de entrada que están
                            destinadas a resolver dudas, aclarar información de
                            la marca, recibir quejas de los usuarios, concertar
                            reuniones con clientes o solventar problemas que
                            parten de los propios clientes. Es la forma efectiva
                            de estar en contacto con un cliente cuando lo
                            requiera.
                          </li>
                          <li>
                            <b>Out Bound</b>: Transacciones de salida, el
                            objetivo es atraer la atención del cliente potencial
                            utilizando eventos, publicidad en medios, e-mail y
                            llamadas no solicitadas y usualmente es con fines
                            comerciales. Se pueden efectuar sondeos en distintos
                            temas, estudios de mercado para saber cuáles son las
                            tendencias actuales, ventas, etc.
                          </li>
                          <li>
                            <b>Ventas</b>: Actividad de venta a través de un
                            ejecutivo de venta especializado y con competencias
                            para vender de forma remota.
                          </li>
                          <li>
                            <b>Soporte</b>: Actividad de encuesta, telefónica a
                            través de un ejecutivo capaz de brindar un rápido
                            levantamiento de información de parte de un cliente.
                          </li>
                        </ul>
                      </div>
                    </Col>
                      ...
                      <div className="paddingCarousel text-justify">
                        <ul>
                          ...
                          <li>
                            ...
                            las debilidades y fortalezas presentadas durante la
                          ...
                          <li>
                            ...
                            acuerdo consistente en intercambiar un bien o
                            servicio entre solicitante y proveedor. Los tipos de
                      ...
                      <div className="paddingCarousel text-justify">
                        <ul>
                          ...
                          <li>
                            ...
                            mala práctica que afecte al usuario final, cliente o
                            CCS ya sea por imagen y/o económicamente
                          </li>
                        </ul>
                      </div>
                    </Col>
