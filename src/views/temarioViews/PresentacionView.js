          ...
          <Row>
            <Col xs="12">
              ...
              <div className="cajaA1">
                Este procedimiento es aplicable al personal de todas las áreas,
                así como a cualquier proyecto que CCS le proporcione el servicio
                de calidad.
                <br />
                <br />
                Esta metodología aplica para todos los canales de interacción.
              </div>
            </Col>
            <Col xs="12 mt-4">
