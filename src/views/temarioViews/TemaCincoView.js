            ...
            <Col xs="12 centrado-fila">
              <Nav tabs className="text-center">
                <NavItem className="d-flex justify-content-center">
                  <NavLink
                    style={{ backgroundColor: "rgba(240, 243, 245, 1) " }}
                    className={
                      (classnames({
                  ...
                  <Row>
                    <Col sm="12 " className="text-justify" centrado-fila>
                      <ul>
                        ...
                        <li>
                          1.3. En paralelo ingresa al aplicativo de CCS y en el
                          apartado de calidad selecciona “Monitoreo”.
                        </li>
                        <li>
                          1.4. Selecciona la guía de acuerdo con la campaña y el
                          tipo de monitoreo de acuerdo con la siguiente tabla.
                        </li>
                        <div className="centrado-fila mt-3">
                          <TablaTipoMotivo />
                        </div>
                        <li>
                          1.5. Ingresa el ID de la grabación obtenida del ACD y
                          en automático se registran los datos como nombre del
                          agente, supervisor, duración de la llamada y la fecha
                          de audio.
                        </li>
                        <li>
                          1.6. En una primera fase el analista de calidad evalúa
                          la llamada con base en el contenido de la guía de
                        ...
                        <li>
                          ...
                          FCR, la gestión del agente, imputable (revisar tabla 1
                          “Imputables”), la tipificación y el ruido o
                            ...
                            this.state.modalIndex === 5 ? (
                              <di className="text-justify">
                                <ul>
                                  ...
                                  <li>
                                    Dentro de la guía el existe el rubro “N/A”
                                    (No aplica), este se considera para los
                                    casos en el que elemento a verificar no se
                                    encuentre durante la llamada por
                              ...
                              <div className="text-justify">
                                <ol>
                                  ...
                                  <li>
                                    ...
                                    descripción del error, selecciona la opción
                                    de “Alerta Operativa”.
                                  </li>
                                  <li>
                                  ...
                                  <li>
                                    Analista notifica a supervisor y coordinador
                                    de Operaciones y determinan sanción.
                                  </li>
                                  <li>
                ...
                <TabPane tabId="3">
                  <Row>
                    <Col sm="12" className="text-justify">
                      ...
                      <p>
                        El tiempo máximo para concluir esta retroalimentación es
                        de 24 horas.
                      </p>
                      <ul>
                        <li>
                          2.1.1. Analista de calidad ingresa al aplicativo de
                          CCS y selecciona la retroalimentación como “Coaching”
                        </li>
                        <li>
                          2.1.2. El analista retroalimenta conforme a las áreas
                          de oportunidad del agente (son aquellas que durante el
                          monitoreo se penalizaron bajo el tipo “NO”).
                        </li>
                        <li>
                        ...
                        <li>
                          ...
                          comportamiento de la retroalimentación y el compromiso
                          colocando su firma.
                        </li>
                        <li>
                          2.1.5. Analista de calidad retroalimenta al agente
                          telefónico y solicita al termino firma de conformidad
                          al agente telefónico.
                        </li>
                  ...
                  <Row>
                    <Col sm="12" className="text-justify">
                      <p>
                        ...
                        deberá retroalimentar de inmediato al agente telefónico.
                      </p>
                      <ul>
                        <li>
                        ...
                        <li>
                          2.2.2. El analista retroalimenta conforme a las áreas
                          de oportunidad del agente, son aquellas que durante el
                          monitoreo se penalizaron bajo el tipo “NO”
                        </li>
                        <li>
                          2.2.3. El analista le indica al agente los rubros que
                          se le penalizaron y retroalimenta sobre cómo puede
                          llevarlos a cabo
                        </li>
                        <li>
