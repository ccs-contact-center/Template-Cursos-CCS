        ...
        <CardBody className="">
          <Row>
            <Col xs="12">
              <Accordion>
                <Col
                  className=" btn bg-fondo-btn fondoAcordeon"
                  style={{ padding: "0" }}
                >
                    ...
                    <div className="mx-3">
                      <Row>
                        <Col xs="12" className="text-justify">
                          <ul className="mt-3">
                            <li>
                              Una vez que el supervisor de operaciones recibe la
                              notificación de un FODA, deberá retroalimentar al
                              agente de inmediato.
                            </li>
                            <li>
                              Realizará un monitoreo de seguimiento para validar
                              la recepción de retroalimentación por parte del
                              agente, no aplicará para bono.
                            </li>
                            <li>
                              Cada semana se revisará con operaciones el
                              concentrado de errores de la operación y se
                              cotejarán con las sanciones. Lo genera calidad, da
                              seguimiento operaciones y RR.HH revisa seguimiento
                              y calificara el seguimiento operativo. COMPARTIR
                            ...
                            <li>
                              En campañas de ventas se penalizará 25 % del bono
                              por error fatal. (revisar matriz de sanciones para
                              error fatal)
                            </li>
                            <li>
                              En campañas de atención a clientes es candado para
                              bono.
                            </li>
                            <li>
                              La cuota de monitoreo de operaciones es 1monitoero
                              por agentes a la semana,
                            </li>
                          </ul>
                        </Col>
                      </Row>
                        ...
                        <Col xs="12" className="text-justify">
                          <ul className="mt-3">
                            <li>
                              ...
                              reporte de calidad y no se mezclan características
                              de los diferentes reportes.
                            </li>
                          </ul>
                          <p>Hot topics</p>
                          <p>
                            Áreas de oportunidad o fortalezas detectadas en la
                            campaña y que tiene relevancia en la resolución del
                            cliente, cuenta o campaña: lo más relevante del día*{" "}
                            <b style={{ color: "red" }}>
                          ...
                          <p>
                            ...
                            monitoreos realizados de manera grupal e individual
                            de cada campaña; así como el comparativo de semana a
                            semana
                          </p>
                          <p>
                            Política **El área de operaciones tiene acceso a la
                            plataforma de reportes para dar seguimiento{" "}
                          </p>
                          <p>
                  ...
                  <Accordion.Collapse eventKey="2">
                    <div className="mx-3">
                      <Row>
                        <Col xs="12" className="text-justify">
                          <p className="mt-3">
                            El reporte tripartita proporciona información sobre
                            el desempeño obtenido durante un tiempo determinado.
                            Se divide en dos tipos: Inbound y Outboun.
                          </p>
                          <p>
                          ...
                          <p>
                            La operación tiene la obligación de revisarlo diario
                            :
                          </p>
                          <p>
                          ...
                          <p>
                            ...
                            seguimiento que ha tenido la campaña, los resultados
                            de su desempeño, áreas de oportunidad grupal e
                            individual, hallazgos reincidentes (tanto
                          ...
                          >
                            <ul>
                              <li>
                                ...
                                calificaciones con promedio de 100% mediante una
                                calibración, los resultados no pueden diferir
                                respecto al + -3 puntos de diferencia.
                              </li>
                            </ul>
                            <p>Calibración </p>
                            <ul>
